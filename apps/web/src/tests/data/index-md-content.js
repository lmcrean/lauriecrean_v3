/**
 * This file contains the actual content from index.md
 * Please paste the entire index.md content between the backticks below
 */

export const indexMdContent = `
// Paste the ENTIRE index.md content here
---
slug: /
title: ""
...
<a href="https://github.com/lmcrean/odyssey-api" target="_blank" class="code-btn"><i class="fa fa-code"></i> code </a> <a href="https://odyssey-docs.lauriecrean.dev" target="_blank" class="readme-btn"><i class="fa fa-book"></i> readme </a> <a href="https://www.figma.com/design/E9mOo72sSEqIjSplAMipFE/Odyssey?node-id=0-1&t=90jvE8D1JwHqgqVY-1" target="_blank" class="figma-btn"><i class="fa fa-paint-brush"></i> mockup </a> <a href="https://odyssey.lauriecrean.dev" target="_blank" class="live-demo-btn"><i class="fa fa-play"></i> live demo </a>
...
<a href="https://github.com/lmcrean/coach-matrix" target="_blank" class="code-btn"><i class="fa fa-code"></i> code </a> <a href="https://github.com/lmcrean/coach-matrix" target="_blank" class="readme-btn"><i class="fa fa-book"></i> readme </a> <a href="https://www.figma.com/design/jXT4Bi1WXVwYG4daO3Yczi/Coach-Matrix?node-id=1-89&t=J0AI0eKKLWvVg5Lj-1" target="_blank" class="figma-btn"><i class="fa fa-paint-brush"></i> mockup </a> <a href="https://coach-matrix-d2cd1e717f81.herokuapp.com/" target="_blank" class="live-demo-btn"><i class="fa fa-play"></i> live demo </a>
...
<a href="https://github.com/lmcrean/steam-report-mern" target="_blank" class="code-btn"><i class="fa fa-code"></i> code </a> <a href="https://steamreport-docs.lauriecrean.dev" target="_blank" class="readme-btn"><i class="fa fa-book"></i> readme </a> <a href="https://www.figma.com/design/r3srLkPpbnMviUOIZeNjk7/Steam-Report?node-id=0-1&t=FBS5ZDxiWmtVBPeq-1" target="_blank" class="figma-btn"><i class="fa fa-paint-brush"></i> mockup </a> <a href="https://steamreport.lauriecrean.dev" target="_blank" class="live-demo-btn"><i class="fa fa-play"></i> live demo </a>
...
<a href="https://github.com/lmcrean/steam-report" target="_blank" class="code-btn"><i class="fa fa-code"></i> code </a> <a href="https://github.com/lmcrean/steam-report" target="_blank" class="readme-btn"><i class="fa fa-book"></i> readme </a> <a href="https://steam-report-4c5b92c32ae5.herokuapp.com/" target="_blank" class="live-demo-btn"><i class="fa fa-play"></i> live demo </a>
...
<a href="https://github.com/lmcrean/odyssey-v2-amplify-vite" target="_blank" class="code-btn"><i class="fa fa-code"></i> code </a> <a href="https://main.d1l70uc5e2kcii.amplifyapp.com/" target="_blank" class="live-demo-btn"><i class="fa fa-play"></i> live demo </a>
...
<a href="https://github.com/lmcrean/odyssey-v2" target="_blank" class="code-btn"><i class="fa fa-code"></i> code </a>
...
<a href="https://github.com/lmcrean/BudgetTool" target="_blank" class="code-btn"><i class="fa fa-code"></i> code </a> <a href="https://github.com/lmcrean/BudgetTool" target="_blank" class="readme-btn"><i class="fa fa-book"></i> readme </a> <button class="live-demo-btn"><i class="fa fa-play"></i> demo expired </button>
...
<img src="/screenshots/antelope.png" alt="antelope" style={{maxHeight: "auto", width: "500px", margin: "auto", display: "flex"}} />

<a href="https://github.com/lmcrean/antelope" target="_blank" class="code-btn"><i class="fa fa-code"></i> code </a> <a href="https://antelope-frontend-isolate-ea7038a582fe.herokuapp.com/" target="_blank" class="live-demo-btn"><i class="fa fa-play"></i> live demo </a>
...
<a href="https://github.com/lmcrean/lauriecrean_nextjs" target="_blank" class="code-btn"><i class="fa fa-code"></i> code </a> <a href="https://lauriecrean.dev" target="_blank" class="live-demo-btn"><i class="fa fa-play"></i> live demo </a>
...
<a href="https://github.com/lmcrean/lauriecrean" target="_blank" class="code-btn"><i class="fa fa-code"></i> code </a> <a href="https://lauriecrean-nextjs-dlpcywpcu-lmcreans-projects.vercel.app/" target="_blank" class="live-demo-btn"><i class="fa fa-play"></i> live demo </a>
...
<a href="https://github.com/lmcrean/hoverboard-react" target="_blank" class="code-btn"><i class="fa fa-code"></i> code </a> <a href="https://hoverboard-react.vercel.app/" target="_blank" class="live-demo-btn"><i class="fa fa-play"></i> live demo </a>
...
<a href="https://github.com/lmcrean/hoverboard" target="_blank" class="code-btn"><i class="fa fa-code"></i> code </a> <a href="https://github.com/lmcrean/hoverboard" target="_blank" class="readme-btn"><i class="fa fa-book"></i> readme </a> <a href="https://www.figma.com/design/W7mEdTvxLgNZTvh1ODiuwD/HOVERBOARD?node-id=0-1&t=KLNqBhNcdgTvlq8M-1" target="_blank" class="figma-btn"><i class="fa fa-paint-brush"></i> mockup </a> <a href="https://lmcrean.github.io/Hoverboard/" target="_blank" class="live-demo-btn"><i class="fa fa-play"></i> live demo </a>
...
<a href="https://github.com/lmcrean/crocodile-kingdom-mern" target="_blank" class="code-btn"><i class="fa fa-code"></i> code </a> <a href="https://crocodilekingdom.lauriecrean.dev/" target="_blank" class="live-demo-btn"><i class="fa fa-play"></i> live demo </a>
...
<a href="https://github.com/lmcrean/crocodile-kingdom" target="_blank" class="code-btn"><i class="fa fa-code"></i> code </a> <a href="https://github.com/lmcrean/crocodile-kingdom" target="_blank" class="readme-btn"><i class="fa fa-book"></i> readme </a> <a href="https://lmcrean.github.io/Crocodile-Kingdom/" target="_blank" class="live-demo-btn"><i class="fa fa-play" ></i> live demo </a>
...
<img src="/screenshots/retrolympics.png" alt="retrolympicrush" style={{maxHeight: "auto", width: "450px", margin: "auto", display: "flex"}} />

<a href="https://github.com/lmcrean/retrolympics-rush" target="_blank" class="code-btn"><i class="fa fa-code"></i> code </a> <a href="https://github.com/lmcrean/retrolympic-rush" target="_blank" class="readme-btn"><i class="fa fa-book"></i> readme </a> <a href="https://lmcrean.github.io/Retrolympics-Rush/" target="_blank" class="live-demo-btn"><i class="fa fa-play"></i> live demo </a> 
...
<img src="/screenshots/wealthquest.png" alt="wealthquest" style={{maxHeight: "auto", width: "450px", margin: "auto", display: "flex"}} />

<a href="https://github.com/lmcrean/Wealth-Quest" target="_blank" class="code-btn"><i class="fa fa-code"></i> code </a> <a href="https://github.com/lmcrean/Wealth-Quest" target="_blank" class="readme-btn"><i class="fa fa-book"></i> readme </a>  <a href="https://lmcrean.github.io/Wealth-Quest/" target="_blank" class="live-demo-btn"> live demo </a>
