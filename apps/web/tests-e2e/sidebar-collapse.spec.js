 ...
 */
test_1.test.describe('Sidebar Collapse', function () {
    (0, test_1.test)('carousel should maintain integrity when sidebar is collapsed', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var carouselSelector, carouselExists, nextButton, prevButton, sidebarCollapseButton, collapseButtonExists;
        var page = _b.page;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 10:
                    ...
                    _c.sent();
                    return [4 /*yield*/, page.locator(carouselSelector).screenshot({
                            path: path_1.default.join('tests-e2e', 'screenshots', 'carousels', 'carousel-after-collapse.png')
                        })];
                case 11:
                    _c.sent();
                ...
                case 13:
                    _c.sent();
                    return [4 /*yield*/, page.locator(carouselSelector).screenshot({
                            path: path_1.default.join('tests-e2e', 'screenshots', 'carousels', 'carousel-next-after-collapse.png')
                        })];
                case 14:
                    _c.sent();
                    return [2 /*return*/];
